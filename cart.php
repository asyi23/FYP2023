...
if(isset($_POST['checkout'])){
    ...
    $sql = "UPDATE product INNER JOIN carts  on product.id = carts.seller SET product.quantity = product.quantity - carts.quantity";
...
$productCount = mysqli_num_rows($sql);
 ...
 if ($productCount > 0) {
    ...
    <tr>
        ...
        <span id="numberPlace" class="place"><?php echo htmlentities($_SESSION["quantity"] );?></span>
