...
if(isset($_POST['login'])){
    ...
    if(is_array($row)){
        ...
        $_SESSION["phone_num"] = $row["phonenumber"];
        ...
        <section class="container-forms">
            <div class="form-login">
                <div class="form-content">
                    <header>Login</header>
                    <form name="f1" action="login_admin.php" onsubmit = "return validation()" method="post">
                        <div class="field-input-field">
                            <input type="email" placeholder="Email" class="input" id="user" name="user">
                        </div>
