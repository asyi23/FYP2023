...
<body>
    ...
    <header class="header">
        ...
        <a href="newprofile.php"class="fas fa-user" id="menu-btn"></a>
    ...
    <div class="discover">
        <img src="image/happybirthday.png" class="image">
        <div class="promo">
            <p>Discount 25% for november baby</p>
    ...
    <div class="cat">
        <div class="side">
        <img src="image/women.jpg"></br>
        <a href="category.php?cat=women">For Women</a>
        </div>
        <div class="side">
        <img src="image/men.jpg"></br> 
        <a href="category.php?cat=men">For Men</a>
        </div>
    </div>
...
<div class="box">
    ...
    <h3 id="name"><?php echo htmlentities($row['product_name']);?> 
     </h3><br>   
        <div class="price" id="price">
            RM <?php echo htmlentities($row['price']);?><br />
        </div>
        <a href="oneviewnew.php?id=<?php echo htmlentities($row['id']);?> " class="detail">View Product Details</a></td>
    <br />
</div>  
<?php 
    }//while
